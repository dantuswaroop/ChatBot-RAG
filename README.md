# 🤖 WSA Process Assistant

A powerful Retrieval-Augmented Generation (RAG) system that allows you to chat with your PDF documents through multiple interfaces: web chat, command line, and interactive terminal. Uses **Ollama** for local AI inference and **FAISS** for fast document retrieval.
